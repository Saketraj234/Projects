        ...
        if (timerSeconds > 0) {
            ...
            timerInterval = setInterval(() => {
                if (timerSeconds > 0) {
                    ...
                    // Add urgency animation when less than 10 seconds remain
                    if (timerSeconds <= 10 && !timerDisplay.classList.contains('urgent')) {
...
function toggleTheme() {
    ...
    const displays = document.querySelectorAll('#stopwatch-display, #timer-display, #current-time, #current-date');
